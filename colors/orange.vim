...
let s:yellow = {'gui': '#f7ea00', 'cterm256': 'NONE'}
let s:green = {'gui': '#00ff00', 'cterm256': 'NONE'}
let s:spring = {'gui': '#00ff55', 'cterm256': 'NONE'}
let s:gay = {'gui': '#aaaaaa', 'cterm256': 'NONE'}
let s:darkgay = {'gui': '#101010', 'cterm256': 'NONE'}
let s:white = {'gui': '#f4dfc6', 'cterm256': 'NONE'}
let s:orang = {'gui': '#ffa724', 'cterm256': 'NONE'}
let s:orange = {'gui': '#ff8700', 'cterm256': '208'}
let s:gren = {'gui': '#88ee00', 'cterm256': '208'}
let s:dirty = {'gui': '#f4cf86', 'cterm256': '208'}
let s:blood = {'gui': '#dd2200', 'cterm256': '196'}
let s:red = {'gui': '#FF0000', 'cterm256': '196'}
...
call <sid>hi('CursorLineNr', s:simpleBlack, s:none, 'none')
...
call <sid>hi('SignColumn', s:simpleBlue2, s:none, 'none')
"call <sid>hi('Normal', s:white, s:simpleBlack, 'none')
call <sid>hi('Normal', s:white, s:none, 'none')
call <sid>hi('MatchParen', s:simpleWhite, s:simpleBlue2, 'none')
call <sid>hi('Pmenu', s:none, s:darkgay, 'none')
...
" General
call <sid>hi('Boolean', s:blood, s:none, 'none')
call <sid>hi('Character', s:simpleGoo, s:none, 'none')
call <sid>hi('Comment', s:gay, s:none, 'none')
call <sid>hi('Conditional', s:red, s:none, 'bold')
call <sid>hi('Constant', s:blood, s:none, 'none')
call <sid>hi('Define', s:simpleLightBlue, s:none, 'none')
call <sid>hi('ErrorMsg', s:simpleWhite, s:simpleRed, 'none')
call <sid>hi('Float', s:blood, s:none, 'none')
call <sid>hi('Function', s:orang, s:none, 'italic')
...
call <sid>hi('Number', s:blood, s:none, 'none')
call <sid>hi('Operator', s:simpleIndianRed, s:none, 'none')
call <sid>hi('PreProc', s:gren, s:none, 'none')
...
call <sid>hi('Statement', s:red, s:none, 'bold')
call <sid>hi('StorageClass', s:red, s:none, 'bold')
...
call <sid>hi('Type', s:orange, s:none, 'bold')
call <sid>hi('Underlined', s:none, s:none, 'underline')
call <sid>hi('WarningMsg', s:simpleRed, s:none, 'none')
...
" Java:
call <sid>hi('javaIdentifier', s:simpleSteel, {}, 'none')
call <sid>hi('javaOperator', s:simpleWhite, {}, 'none')
call <sid>hi('javaAccessKeyword', s:simpleRed2, {}, 'none')
call <sid>hi('javaStorageClass', s:simpleRed2, {}, 'none')
call <sid>hi('javaStructure', s:simpleRed2, {}, 'none')
call <sid>hi('javaConditional', s:simpleRed2, {}, 'none')
call <sid>hi('javaStatement', s:simpleRed2, {}, 'none')
call <sid>hi('javaRepeat', s:simpleRed2, {}, 'none')
call <sid>hi('javaInclude', s:simpleRed2, {}, 'none')
call <sid>hi('javaLabel', s:simpleRed2, {}, 'none')
call <sid>hi('javaComment', s:simpleGreen, s:none, 'none')
...
call <sid>hi('javaFunction', s:yellow, {}, 'none')

" Cpp:
call <sid>hi('Statement', s:simpleRed2, {}, 'bold')
call <sid>hi('cppType', s:simpleRed2, {}, 'bold')

call <sid>hi('LspCxxHlSymFunction', s:orang, {}, 'italic')
call <sid>hi('LspCxxHlSymMethod', s:orang, {}, 'italic')
call <sid>hi('LspCxxHlSymMacro', s:gren, {}, 'none')
call <sid>hi('LspCxxHlSymClass', s:orange, {}, 'bold')
call <sid>hi('LspCxxHlSymNamespace', s:simpleOrange, {}, 'bold')
call <sid>hi('LspCxxHlSymParameter', s:dirty, {}, 'italic')
call <sid>hi('cIncluded', s:dirty, {}, 'underline')
call <sid>hi('cString', s:simpleGreen, {}, 'none')
call <sid>hi('cType', s:simpleRed2, {}, 'bold')
call <sid>hi('cStatement', s:simpleRed2, {}, 'bold')
call <sid>hi('cppStatement', s:simpleRed2, {}, 'bold')
call <sid>hi('cRepeat', s:simpleRed2, {}, 'bold')
call <sid>hi('cConditional', s:simpleRed2, {}, 'bold')
call <sid>hi('cInclude', s:gren, {}, 'bold')
call <sid>hi('cppNumber', s:blood, {}, 'none')
call <sid>hi('cNumber', s:blood, {}, 'none')
call <sid>hi('cppConstant', s:blood, {}, 'none')

call <sid>hi('TSNamespace', s:simpleOrange, {}, 'bold')
call <sid>hi('TSKeyword', s:simpleRed2, {}, 'bold')
call <sid>hi('TSNumber', s:blood, {}, 'none')
call <sid>hi('TSProperty', s:white, {}, 'none')
call <sid>hi('TSVariable', s:dirty, {}, 'none')
call <sid>hi('TSParameter', s:dirty, {}, 'italic')
call <sid>hi('TSConstructor', s:simpleOrange, {}, 'bold')
call <sid>hi('TSConstMacro', s:gren, {}, 'none')

call <sid>hi('LspDiagnosticsVirtualTextError', s:simpleRed2, {}, 'none')
